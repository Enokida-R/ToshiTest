...
function ResultB() {
    ...
    const quiz=[
        {
            question:'21.どちらかというと？ (E:話すより聞く方が好き F:聞くのも好きだけそ、熱く語るのも好き)',
            answers:[
                'E',
                'e',
                '?',
            ...
            question:'22.恋人とはどんな関係が理想 (E:一緒にいて落ち着く関係 F:お互いの全てをわかりあう関係)',
            answers:[
                'E',
                'e',
                '?',
            ...
            question:'23.趣味にハマることある？ (E:特に何かに熱中できない F:熱く語りたい趣味がいくつある',
            answers:[
                'E',
                'e',
                '?',
            ...
            question:'24.クラスの人気者や中心人物をどう思う？ (E:自分とは関係ない人 F:なんとなく憧れてしまう)',
            answers:[
                'E',
                'e',
                '?',
            ...
            question:'25.こういう『性格テスト』をどう思う？ (E:鵜呑みにはしないが興味はある F:人間はタイプ分けなどできないはず)',
            answers:[
                'E',
                'e',
                '?',
            ...
            question:'26.自分のこと好きか (E:そんなことは考えない F:時々、すごくイヤになる)',
            answers:[
                'E',
                'e',
                '?',
            ...
            question:'27.好きな人ができた。さてどうなる？ (E:なぜ好きか、どこが好きか考える F:自分の気持ちが止まらなくなる)',
            answers:[
                'E',
                'e',
                '?',
            ...
            question:'28.小さい子供の頃、ものすごく好きなおもちゃやグッズなどがあった (E:特になかった F:手放せず、無いと泣いたりした)',
            answers:[
                'E',
                'e',
                '?',
            ...
            question:'29.買い物で買う・買わないの基準は (E:必要、無難、効率、手頃 F:好き、自分らしい、かっこいい)',
            answers:[
                'E',
                'e',
                '?',
            ...
            question:'30.あなたの説明、わからないと言われる時の理由は？ (E:合っているけど身も蓋も無い F:長くてまどろっこしい)',
            answers:[
                'E',
                'e',
                '?',
            ...
            question:'31.ノルマ、締切などの言葉を聞くと思い浮かべるイメージは？ (E:調整、段取り、工夫、計画 F:管理、数学、賞罰、成果)',
            answers:[
                'E',
                'e',
                '?',
            ...
            question:'32.あなたがすごくイヤだと感じるのは、どっち？ (E:指示ミスで仕事が無駄になること F:間違っていると思うことを強制されることo』)',
            answers:[
                'E',
                'e',
                '?',
