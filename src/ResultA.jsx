...
function ResultA() {
    ...
    const quiz=[
        {
            question:'21.どちらかというと？ (C:目立ちたがり D:仕切り屋)',
            answers:[
                'C',
                'c',
                '?',
            ...
            question:'22.泣いて頼まれたら (C:『いや』とは言えない D:みっともないと思ってしまう)',
            answers:[
                'C',
                'c',
                '?',
            ...
            question:'23.クラスで一番才能のある人とは (C:友達になりたい D:ライバルとして認めてもらいたい)',
            answers:[
                'C',
                'c',
                '?',
            ...
            question:'24.好きな人に、『自分は惚れられている』と実感できるのは (C:全てが好きと言われる時 D:相手の愛情の方が大きいと感じる時)',
            answers:[
                'C',
                'c',
                '?',
            ...
            question:'25.どんなプレゼントをあげたい (C:自分があげたいもの D:誰もが納得できる価値があるもの)',
            answers:[
                'C',
                'c',
                '?',
            ...
            question:'26.『よし、明日から早起きするぞ！』と宣言した。さてどうなる？ (C:３日で忘れる D:言った限りは守る)',
            answers:[
                'C',
                'c',
                '?',
            ...
            question:'27.恋人とそろそろ危ない感じ。別れるならどうする？ (C:別の人を好きになりフェードアウト D:相手が言い出す前に切り出す)',
            answers:[
                'C',
                'c',
                '?',
            ...
            question:'28.子供の頃遊ぶ時は (C:気に合う友達を誘って遊んだ D:得意な遊ぶに友達を誘った)',
            answers:[
                'C',
                'c',
                '?',
            ...
            question:'30.先輩からは、同僚と比べ自分の方が (C:目をかけられると嬉しい D:評価されると嬉しい)',
            answers:[
                'C',
                'c',
                '?',
            ...
            question:'31.後輩から、どう思われているとわかったらショック？ (C:怖がられ、嫌われている D:バカにされ、みくびられている)',
            answers:[
                'C',
                'c',
                '?',
